...
import moe.pxe.macecompanion.util.*
...
enum class Modifiers {
    DOUBLE {
        ...
        override val customIcon: ItemStack = Items.MACE.customIconWithCooldown("modifiers/double_mace")
    },
    ...
    TRIPLE {
        ...
        override val customIcon: ItemStack = Items.MACE.customIconWithCooldown("modifiers/triple_mace")
    },
    ...
    QUADRUPLE {
        ...
        override val customIcon: ItemStack = Items.MACE.customIconWithCooldown("modifiers/quadruple_mace")
    },

    TINY {
        override val matchName = "Tiny Mace"
        override val icon: ItemStack = Items.STONE_BUTTON.defaultInstance
        override val customIcon: ItemStack = Items.STONE_BUTTON.customIcon("modifiers/tiny_mace")
    },

    BIG {
        override val matchName = "Big Mace"
        override val icon: ItemStack = Items.STONE.defaultInstance
        override val customIcon: ItemStack = Items.STONE.customIcon("modifiers/big_mace")
    },
    ...
    SLOW_TIME {
        ...
        override val customIcon: ItemStack = Items.CLOCK.customIcon("modifiers/slow_time")
    },
    ...
    FAST_TIME {
        ...
        override val customIcon: ItemStack = Items.CLOCK.customIcon("modifiers/fast_time")
    },
    ...
    MISS_EQUALS_DIE {
        ...
        override val customIcon: ItemStack = Items.PLAYER_HEAD.customIcon("modifiers/miss_equals_die")
    },
    ...
    SHOCKWAVE {
        ...
        override val customIcon: ItemStack = Items.HEART_OF_THE_SEA.customIconWithCooldown("modifiers/shockwave_mace")
    },

    ELYTRA {
        override val matchName = "Elytra Launch"
        override val icon: ItemStack = Items.ELYTRA.defaultInstance
        override val customIcon: ItemStack = Items.ELYTRA.customIcon("modifiers/elytra_launch")
    },
    ...
    PICKAXE {
        ...
        override val customIcon: ItemStack = Items.STONE_PICKAXE.customIcon("modifiers/pickaxe")
    },
    ...
    WIND_BURST {
        ...
        override val customIcon: ItemStack = Items.BREEZE_ROD.customIcon("modifiers/wind_burst")
    },

    VICTIM {
        override val matchName = "Victim Mace"
        override val icon: ItemStack = Items.SPECTRAL_ARROW.defaultInstance
        override val customIcon: ItemStack = Items.SPECTRAL_ARROW.customIcon("modifiers/victim_mace")
    },

    CEILING {
        override val matchName = "Ceiling"
        override val icon: ItemStack = Items.WAXED_OXIDIZED_COPPER_TRAPDOOR.defaultInstance
        override val customIcon: ItemStack = Items.WAXED_OXIDIZED_COPPER_TRAPDOOR.customIcon("modifiers/ceiling")
    },
    ...
    RANDOM_SIZE {
        ...
        override val customIcon: ItemStack = Items.PLAYER_HEAD.customIcon("modifiers/random_size")
    },

    GLOWING {
        override val matchName = "Glow in the Dark"
        override val icon: ItemStack = Items.GLOW_INK_SAC.defaultInstance
        override val customIcon: ItemStack = Items.GLOW_INK_SAC.customIcon("modifiers/glow_in_the_dark")
    },

    MOVE_EQUALS_GROW {
        override val matchName = "Move = Grow"
        override val icon: ItemStack = Items.CHAINMAIL_BOOTS.defaultInstance
        override val customIcon: ItemStack = Items.CHAINMAIL_BOOTS.customIcon("modifiers/move_equals_grow")
    },

    PINATA {
        override val matchName = "Piñata"
        override val icon: ItemStack = Items.HORSE_SPAWN_EGG.defaultInstance
        override val customIcon: ItemStack = Items.HORSE_SPAWN_EGG.customIcon("modifiers/pinata")
    },

    EXPLOSIVE {
        override val matchName = "Explosive Burst"
        override val icon: ItemStack = Items.TNT_MINECART.defaultInstance
        override val customIcon: ItemStack = Items.TNT_MINECART.customIcon("modifiers/explosive_burst")
    },

    NO_JUMPING {
        override val matchName = "No Jumping"
        override val icon: ItemStack = Items.RABBIT_FOOT.defaultInstance
        override val customIcon: ItemStack = Items.RABBIT_FOOT.customIcon("modifiers/no_jumping")
    },

    STACKS {
        override val matchName = "Stacks"
        override val icon: ItemStack = Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE.defaultInstance
        override val customIcon: ItemStack = Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE.customIcon("modifiers/stacks")
    },
    ...
    LUNGE {
        ...
        override val customIcon: ItemStack = Items.COPPER_SPEAR.customIconWithCooldown("modifiers/lunge")
    },

    RODS {
        override val matchName = "Fishing Rods"
        override val icon: ItemStack = Items.FISHING_ROD.defaultInstance
        override val customIcon: ItemStack = Items.FISHING_ROD.customIcon("modifiers/fishing_rods")
    },

    MAGNETIC {
        override val matchName = "Magnetic Burst"
        override val icon: ItemStack = Items.IRON_NAUTILUS_ARMOR.defaultInstance
        override val customIcon: ItemStack = Items.FISHING_ROD.customIcon("modifiers/magnetic_burst")
    },
    ...
    SNOWBALL {
        ...
        override val customIcon: ItemStack = Items.POWDER_SNOW_BUCKET.customIconWithCooldown("modifiers/snowball_fight")
    },

    SOUL_FLOOR {
        override val matchName = "Soul Floor"
        override val icon: ItemStack = Items.SOUL_SAND.defaultInstance
        override val customIcon: ItemStack = Items.SOUL_SAND.customIcon("modifiers/soul_floor")
    },
    ...
    STICKY {
        ...
        override val customIcon: ItemStack = Items.HONEY_BLOCK.customIcon("modifiers/sticky_floor")
    },

    LEVITATION {
        override val matchName = "Levitation Burst"
        override val icon: ItemStack = Items.ALLAY_SPAWN_EGG.defaultInstance
        override val customIcon: ItemStack = Items.ALLAY_SPAWN_EGG.customIcon("modifiers/levitation_burst")
    },

    TOTEM {
        override val matchName = "Steal the Totem"
        override val icon: ItemStack = Items.TOTEM_OF_UNDYING.defaultInstance
        override val customIcon: ItemStack = Items.TOTEM_OF_UNDYING.customIcon("modifiers/steal_the_totem")
    },

    SPIKES {
        override val matchName = "Spikes"
        override val icon: ItemStack = Items.POINTED_DRIPSTONE.defaultInstance
        override val customIcon: ItemStack = Items.POINTED_DRIPSTONE.customIcon("modifiers/spikes")
    },

    MIRROR {
        override val matchName = "Mirror"
        override val icon: ItemStack = Items.WHITE_BANNER.defaultInstance
        override val customIcon: ItemStack = Items.WHITE_BANNER.customIcon("modifiers/mirror")
    },

    MINEFIELD {
        override val matchName = "Minefield"
        override val icon: ItemStack = Items.MANGROVE_PRESSURE_PLATE.defaultInstance
        override val customIcon: ItemStack = Items.MANGROVE_PRESSURE_PLATE.customIcon("modifiers/minefield")
    },

    BOUNCY_CHARGES {
        override val matchName = "Bouncy Charges"
        override val icon: ItemStack = Items.SLIME_BALL.defaultInstance
        override val customIcon: ItemStack = Items.SLIME_BALL.customIcon("modifiers/bouncy_charges")
    },

    PUNCH_EQUALS_FREEZE {
        override val matchName = "Punch = Freeze"
        override val icon: ItemStack = Items.SNOWBALL.defaultInstance
        override val customIcon: ItemStack = Items.SNOWBALL.customIcon("modifiers/punch_equals_freeze")
    },
    ...
    SQUARE_MAP {
        ...
        override val customIcon: ItemStack = Items.STONE_PRESSURE_PLATE.customIcon("modifiers/square_map")
    },

    LIGHTNING_MACE {
        override val matchName = "Lightning Mace"
        override val icon: ItemStack = Items.WAXED_LIGHTNING_ROD.defaultInstance
        override val customIcon: ItemStack = Items.WAXED_LIGHTNING_ROD.customIcon("modifiers/lightning_mace")
    },

    REWIND {
        override val matchName = "Rewind"
        override val icon: ItemStack = Items.PURPLE_HARNESS.defaultInstance
        override val customIcon: ItemStack = Items.PURPLE_HARNESS.customIcon("modifiers/rewind")
    },

    UMBRELLA {
        override val matchName = "Umbrella"
        override val icon: ItemStack = Items.CRIMSON_FUNGUS.defaultInstance
        override val customIcon: ItemStack = Items.CRIMSON_FUNGUS.customIcon("modifiers/umbrella")
    },

    KEEP_SPRINTING {
        override val matchName = "Keep Sprinting"
        override val icon: ItemStack = Items.COPPER_BOOTS.defaultInstance
        override val customIcon: ItemStack = Items.COPPER_BOOTS.customIcon("modifiers/keep_sprinting")
    },

    HONEY_BURST {
        override val matchName = "Honey Burst"
        override val icon: ItemStack = Items.HONEY_BLOCK.defaultInstance
        override val customIcon: ItemStack = Items.HONEY_BLOCK.customIcon("modifiers/honey_burst")
    },
    ...
    UNKNOWN {
        ...
        override val customIcon: ItemStack = Items.MACE.customIconWithCooldown("modifiers/unknown")
    },
    ...
    MYSTERY {
        ...
        override val customIcon: ItemStack = Items.LIGHT_GRAY_CANDLE.customIcon("modifiers/mystery")
    };

...
enum class Modifiers {
    ...
    LIGHTNING_MACE {
        ...
        override val icon: ItemStack = Items.LIGHTNING_ROD.waxed.unaffected.defaultInstance
        override val customIcon: ItemStack = Items.LIGHTNING_ROD.waxed.unaffected.defaultInstance.apply {
    ...
    REWIND {
        ...
        override val customIcon: ItemStack = Items.HARNESS.purple.defaultInstance.apply {

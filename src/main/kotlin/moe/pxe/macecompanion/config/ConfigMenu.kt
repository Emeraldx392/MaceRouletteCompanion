            ...
            .category(ConfigCategory.createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                    ...
                    .option(Option.createBuilder<HudLocation>()
                        .name(Text.translatable("mrc.config.category.roundhud.group.hudtransforms.option.leftHudLocation"))
                        .description(OptionDescription.of(Text.translatable("mrc.config.category.roundhud.group.hudtransforms.option.leftHudLocation.description")))
                        .binding(Config.leftHudLocation.asBinding())
                        .controller { EnumControllerBuilder.create(it).enumClass(HudLocation::class.java) }
                        .build())
                    .option(Option.createBuilder<HudLocation>()
                        .name(Text.translatable("mrc.config.category.roundhud.group.hudtransforms.option.rightHudLocation"))
                        .description(OptionDescription.of(Text.translatable("mrc.config.category.roundhud.group.hudtransforms.option.rightHudLocation.description")))
                ...
                .group(ListOption.createBuilder<HudElements>()
                    .name(Text.translatable("mrc.config.category.roundhud.group.leftHudElements"))
                    .description(OptionDescription.of(Text.translatable("mrc.config.category.roundhud.group.leftHudElements.description")))
                    ...
                    .build())
                .group(ListOption.createBuilder<HudElements>()
                    .name(Text.translatable("mrc.config.category.roundhud.group.rightHudElements"))
                    .description(OptionDescription.of(Text.translatable("mrc.config.category.roundhud.group.rightHudElements.description")))
                ...
                .group(OptionGroup.createBuilder()
                    ...
                    .description(OptionDescription.of(Text.translatable("mrc.config.category.toasts.group.game.description")))
                        .option(Option.createBuilder<Boolean>()
                            ...
                            .build())
                        .option(Option.createBuilder<Boolean>()
                            .name(Text.translatable("mrc.config.category.toasts.group.game.option.showConsumableToasts"))
                            .description(OptionDescription.of(Text.translatable("mrc.config.category.toasts.group.game.option.showConsumableToasts.description")))

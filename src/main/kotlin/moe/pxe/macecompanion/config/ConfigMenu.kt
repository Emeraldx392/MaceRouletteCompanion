    ...
    fun generateScreen(parent: Screen): Screen? {
        return YetAnotherConfigLib.createBuilder()
            ...
            .category(ConfigCategory.createBuilder()
                ...
                .option(Option.createBuilder<Boolean>()
                    .name(Text.translatable("mrc.config.category.toasts.option.showNewEventToasts"))
                    .description(OptionDescription.of(Text.translatable("mrc.config.category.toasts.option.showNewEventToasts.description")))
                    .binding(Config.showNewEventToasts.asBinding())
                    .controller(TickBoxControllerBuilder::create)
                    .build())
                .option(Option.createBuilder<Boolean>()
                    .name(Text.translatable("mrc.config.category.toasts.option.showBountyToasts"))
                    .description(OptionDescription.of(Text.translatable("mrc.config.category.toasts.option.showBountyToasts.description")))

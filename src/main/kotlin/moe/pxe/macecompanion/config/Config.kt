...
object Config : JsonFileCodecConfig<Config>(FabricLoader.getInstance().configDir.resolve("mrc.json")) {
    ...
    fun getRoundTextAccentStyle(defaultColor: Int) : Style {
        ...
        return deafultStyle.let { if (overrideRoundColors.value) it.withColor(roundTextColor.value.rgb and 0x00ffffff) else if (useAccentColors.value) it.withColor(mainAccentColor.value.rgb and 0x00ffffff) else it}
    }
    fun getRoundNumberAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overrideRoundColors.value) it.withColor(roundNumberColor.value.rgb and 0x00ffffff) else if (useAccentColors.value){ if(accentColorNumber.value > 1) it.withColor(secondAccentColor.value.rgb and 0x00ffffff) else it.withColor(mainAccentColor.value.rgb and 0x00ffffff)} else it}
    }

    fun getPlayerCountTextAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overridePlayerCountColors.value) it.withColor(playerCountTextColor.value.rgb and 0x00ffffff) else if (useAccentColors.value) it.withColor(mainAccentColor.value.rgb and 0x00ffffff) else it}
    }
    fun getAlivePLayersAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overridePlayerCountColors.value) it.withColor(alivePlayersColor.value.rgb and 0x00ffffff) else if (useAccentColors.value) { if(accentColorNumber.value > 1) it.withColor(secondAccentColor.value.rgb and 0x00ffffff) else it.withColor(mainAccentColor.value.rgb and 0x00ffffff)} else it}
    }
    ...
    fun getEliminationsTextAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overrideEliminationsColors.value) it.withColor(eliminationsTextColor.value.rgb and 0x00ffffff) else if (useAccentColors.value) it.withColor(mainAccentColor.value.rgb and 0x00ffffff) else it}
    }
    fun getEliminationsNumberAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overrideEliminationsColors.value) it.withColor(eliminationsNumberColor.value.rgb and 0x00ffffff) else if (useAccentColors.value) { if(accentColorNumber.value > 1) it.withColor(secondAccentColor.value.rgb and 0x00ffffff) else it.withColor(mainAccentColor.value.rgb and 0x00ffffff)} else it}
    }
    ...
    fun getStarFragmentsTextAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overrideStarFragmentsColors.value) it.withColor(starFragmentsTextColor.value.rgb and 0x00ffffff) else if (useAccentColors.value) it.withColor(mainAccentColor.value.rgb and 0x00ffffff) else it}
    }
    fun getStarFragmentsNumberAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overrideStarFragmentsColors.value) it.withColor(starFragmentsNumberColor.value.rgb and 0x00ffffff) else if (useAccentColors.value) { if(accentColorNumber.value > 1) it.withColor(secondAccentColor.value.rgb and 0x00ffffff) else it.withColor(mainAccentColor.value.rgb and 0x00ffffff)} else it}
    }
    fun getStarFragmentsIconAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overrideStarFragmentsColors.value) it.withColor(starFragmentsIconColor.value.rgb and 0x00ffffff) else if (useAccentColors.value) { if(accentColorNumber.value > 2) it.withColor(thirdAccentColor.value.rgb and 0x00ffffff) else  it.withColor(mainAccentColor.value.rgb and 0x00ffffff)} else it}
    }

    fun getPlaytimeTextAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overridePlaytimeColors.value) it.withColor(playtimeTextColor.value.rgb and 0x00ffffff) else if (useAccentColors.value) it.withColor(mainAccentColor.value.rgb and 0x00ffffff) else it}
    }
    fun getPlaytimeNumberAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overridePlaytimeColors.value) it.withColor(playtimeColor.value.rgb and 0x00ffffff) else if (useAccentColors.value) { if(accentColorNumber.value > 1) it.withColor(secondAccentColor.value.rgb and 0x00ffffff) else it.withColor(mainAccentColor.value.rgb and 0x00ffffff)} else it}
    }
    fun getPlaytimeIconAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overridePlaytimeColors.value) it.withColor(playtimeIconColor.value.rgb and 0x00ffffff) else if (useAccentColors.value) { if(accentColorNumber.value > 2) it.withColor(thirdAccentColor.value.rgb and 0x00ffffff) else  it.withColor(mainAccentColor.value.rgb and 0x00ffffff)} else it}
    }

    fun getModifiersTextAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overrideModifiersColors.value) it.withColor(modifiersTextColor.value.rgb and 0x00ffffff) else if (useAccentColors.value) it.withColor(mainAccentColor.value.rgb and 0x00ffffff) else it}
    }
    fun getNormalModifierTextAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overrideModifiersColors.value) it.withColor(normalModifierTextColor.value.rgb and 0x00ffffff) else it}
    }
    fun getEternalModifierTextWithShadowAccentStyle(defaultColor: Int, defaultShadowColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor).withShadowColor(defaultShadowColor)
        return deafultStyle.let { if (overrideModifiersColors.value) it.withColor(eternalModifierTextColor.value.rgb and 0x00ffffff).withShadowColor(eternalModifierTextShadowColor.value.rgb and 0x00ffffff) else it}
    }
    fun getChargedModifierTextAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overrideModifiersColors.value) it.withColor(chargedModifierTextColor.value.rgb and 0x00ffffff) else it}
    }
    fun getMysteryModifierTextAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overrideModifiersColors.value) it.withColor(mysteryModifierTextColor.value.rgb and 0x00ffffff) else it}
    }

    fun getMaceChanceTextAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overrideMaceChanceColors.value) it.withColor(maceChanceTextColor.value.rgb and 0x00ffffff) else if (useAccentColors.value) it.withColor(mainAccentColor.value.rgb and 0x00ffffff) else it}
    }
    fun getMaceChanceNumberAccentStyle(defaultColor: Int) : Style {
        val deafultStyle = Style.EMPTY.withColor(defaultColor)
        return deafultStyle.let { if (overrideMaceChanceColors.value) it.withColor(maceChanceNumberColor.value.rgb and 0x00ffffff) else if (useAccentColors.value) { if(accentColorNumber.value > 1) it.withColor(secondAccentColor.value.rgb and 0x00ffffff) else it.withColor(mainAccentColor.value.rgb and 0x00ffffff)} else it}
    }
